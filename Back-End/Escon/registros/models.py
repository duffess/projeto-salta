...
class Contrato_Spot(models.Model):
    ...
    marca = models.ForeignKey(Marca_Base, on_delete=models.DO_NOTHING, to_field='marca')
    unidade = models.ForeignKey(Unidade_Base, on_delete=models.DO_NOTHING, to_field='unidade_operacoes')
    fornecedor = models.ForeignKey(Fornecedor, on_delete=models.DO_NOTHING, to_field='documento')
    natureza_orcamentaria = models.ForeignKey(NaturezaOrcamentaria_Base, on_delete=models.DO_NOTHING, to_field='linha_orc')
